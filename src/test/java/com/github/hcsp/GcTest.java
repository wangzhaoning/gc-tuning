...
public class GcTest {
    ...
    // 请不要调整-Xms和-Xmx
    private static final String JVM_ARGS = "-Dfile.encoding=UTF-8 -Xms256m -Xmx256m -XX:NewSize=140m -XX:SurvivorRatio=100 -XX:+PrintGCDetails -XX:+PrintGCDateStamps -XX:+PrintGCTimeStamps -XX:+PrintHeapAtGC";
    ...
    private static class ApplicationThread extends Thread {
        ...
        public synchronized void start() {
            List<String> args = new ArrayList<>(Collections.singletonList(System.getProperty("java.home") + "/bin/java"));
