...
public class GcTest {
    ...
    // 请不要调整-Xms和-Xmx
    private static final String JVM_ARGS = "-Dfile.encoding=UTF-8 -XX:+UseConcMarkSweepGC -Xms256m -Xmx256m -XX:NewSize=140m -XX:SurvivorRatio=100 -XX:+PrintGCDetails -XX:+PrintGCDateStamps -XX:+PrintGCTimeStamps";
